...
const Postgres = require("../databases/strategies/postgres/Postgres");
const HeroSchema = require("../databases/strategies/postgres/schemas/heroSchema");
...
describe("Tests of Postgres Strategy", function () {
    ...
    this.beforeAll(async () => {
        ...
        database = new ContextDatabase(new Postgres(connection, model));
